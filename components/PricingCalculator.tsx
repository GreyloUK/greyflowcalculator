  ...
  const formatPrice = (price: number) => {
    ...
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {services.map((service) => {
          ...
          return (
            ...
            >
              {/* Selection Indicator */}
              <div className="absolute top-4 right-4" style={{ pointerEvents: 'none' }}>
              ...
              {/* Service Content */}
              <div className="pr-8" style={{ pointerEvents: 'none' }}>
                <h3 className="text-xl font-semibold text-greyflow-text mb-2">
                  {service.name}
                </h3>
                <p className="text-greyflow-text font-medium mb-3">
                  {service.tagline}
                </p>
                <p className="text-greyflow-secondary text-sm mb-4">
                  {service.description}
                </p>
                ...
                {/* Price */}
                <div className="text-2xl font-bold text-greyflow-text">
      ...
      {selectedServices.length > 0 && (
        <div className="bg-greyflow-card rounded-xl p-6 border border-greyflow-secondary-purple">
          <h2 className="text-2xl font-semibold text-greyflow-text mb-6">
          ...
          {hasDiscount && (
            <div className="bg-greyflow-primary/10 border border-greyflow-primary/30 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-center">
                <span className="text-greyflow-primary font-semibold text-lg">
                  🎉 Bundle and save 15%
                </span>
              </div>
            </div>
          ...
          {/* Totals */}
          <div className="border-t border-greyflow-secondary-purple pt-4 space-y-3">
            {oneOffTotal > 0 && (
              <div className="flex justify-between items-center">
                <span className="text-greyflow-secondary">One-off total:</span>
                <span className="text-greyflow-text font-semibold text-lg">
            ...
            <div className="flex justify-between items-center text-xl font-bold pt-2 border-t border-greyflow-secondary-purple">
      ...
      <div className="text-center mt-8">
        <button
          className="bg-greyflow-primary hover:bg-greyflow-primary/90 text-white font-semibold py-4 px-8 rounded-xl text-lg transition-all duration-300 hover:shadow-lg hover:shadow-greyflow-primary/30 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-greyflow-primary/50"
          aria-label="Get started with GreyFlow services"
        >
          Get Started
        </button>
        <p className="text-greyflow-secondary text-sm mt-4">
